 ...
 * For example, the task "Write code module 1" must finish before the task "test code module 1" can begin.
 *
 ...
 * The task "write training manual" must start before the task "write chapter 1 of training manual" can start.
 *
