...
import { IsString, IsEnum, IsNumber, ValidateNested, IsMongoId, IsOptional, IsDateString, IsBoolean } from 'class-validator';
...
const projectSchema = new Schema({
    ...
    {
        timestamps: true,
        collection: 'project_manager__projects' // TODO: change this later
    }
);
